...
my_list.sort()
list = [0] * 5
combined = new_list + list
a = my_list[1:5]
a = my_list[1:5:2] #step 2 for index 1-5
list_copy = a.copy()
a= [1,2,3,4,5,6]
asquared = [i*i for i in a] #expression then iteration

#tuple, ordered immutable
myTuple = ("max", 28, "Boston")
mtupled = tuple(["a","d","e","r","g","a"])
for i in myTuple:
    print(i)
if "a" in mtupled:
    print("yes")
mtupled.len()
mtupled.count('a') ##number of a's
mtupled.index('a') #first index of a

a = mtupled[0:4] #element 0-3 included
b = a[::-1] #reverse tuple
